...
.curl-request
include::{snippets}/find-all-feed-by-nickname/curl-request.adoc[]

.http-request
include::{snippets}/find-all-feed-by-nickname/http-request.adoc[]

.request-headers
include::{snippets}/find-all-feed-by-nickname/request-headers.adoc[]

.request-param
include::{snippets}/find-all-feed-by-nickname/request-parameters.adoc[]

.http-response
include::{snippets}/find-all-feed-by-nickname/http-response.adoc[]

.response-fields
include::{snippets}/find-all-feed-by-nickname/response-fields.adoc[]

=== tagName으로 모든 Feed 검색
.curl-request
include::{snippets}/find-all-feed-by-tagname/curl-request.adoc[]

.http-request
include::{snippets}/find-all-feed-by-tagname/http-request.adoc[]

.request-headers
include::{snippets}/find-all-feed-by-tagname/request-headers.adoc[]

.request-param
include::{snippets}/find-all-feed-by-tagname/request-parameters.adoc[]

.http-response
include::{snippets}/find-all-feed-by-tagname/http-response.adoc[]

.response-fields
include::{snippets}/find-all-feed-by-tagname/response-fields.adoc[]
